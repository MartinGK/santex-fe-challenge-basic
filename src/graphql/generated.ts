...
export type GetProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductList', items: Array<{ __typename?: 'Product', id: string, name: string, description: string, variants: Array<{ __typename?: 'ProductVariant', price: any, priceWithTax: any }>, featuredAsset?: { __typename?: 'Asset', preview: string } | null }> } };

export type GetCurrentOrderQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentOrderQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', id: string, code: string, state: string, total: any, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, featuredAsset?: { __typename?: 'Asset', preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any } }> } | null };


export const AddItemToOrderDocument = gql`
    mutation AddItemToOrder($productId: ID!, $quantity: Int!) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    AddItemToOrder(variables: AddItemToOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AddItemToOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddItemToOrderMutation>(AddItemToOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'AddItemToOrder', 'mutation');
    },
    ...
    GetCurrentOrder(variables?: GetCurrentOrderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCurrentOrderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCurrentOrderQuery>(GetCurrentOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetCurrentOrder', 'query');
    }
  };
}
